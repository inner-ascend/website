...
function getParser(id) {
  ...
  if (id.endsWith("one-entry-native"))
    return parsers[".tsx"];
  var extension = (0, import_node_path.extname)(id), parser = extension ? parsers[extension] : parsers[".js"];
...
function index_default(_options) {
  var hasTransformed = {}, asyncGeneratorRegex = /(async \*|async function\*|for await)/, transformWithoutGenerators = async function(code, id) {
    ...
    return hasTransformed[id] = !0, await (0, import_core.transform)(code, {
      ...
      jsc: {
        ...
        transform: {
          useDefineForClassFields: !0,
          react: {
            development: !(_options != null && _options.production),
            refresh: !1,
            runtime: "automatic"
          }
        }
    ...
    mode: (_options_mode = _options == null ? void 0 : _options.mode) !== null && _options_mode !== void 0 ? _options_mode : "serve",
    jsxImportSource: (_options_jsxImportSource = _options == null ? void 0 : _options.jsxImportSource) !== null && _options_jsxImportSource !== void 0 ? _options_jsxImportSource : "react",
    tsDecorators: _options == null ? void 0 : _options.tsDecorators,
    plugins: _options != null && _options.plugins ? _options == null ? void 0 : _options.plugins.map(function(el) {
      return [
        resolve(el[0]),
        el[1]
      ];
    }) : void 0,
    production: _options == null ? void 0 : _options.production
  };
  return [
    {
      name: "vite:react-swc",
