...
import { transformGenerators } from "./transformBabel.mjs";
function shouldSourceMap() {
  return process.env.VXRN_ENABLE_SOURCE_MAP === "1";
}
const resolve = createRequire(typeof __filename < "u" ? __filename : import.meta.url).resolve,
...
var index_default = _options => {
  const hasTransformed = {},
    ...
    transformWithGenerators = async (code, id) => {
      if (process.env.VXRN_USE_BABEL_FOR_GENERATORS) return await transformGenerators(code);
      const parser = getParser(id);
      return hasTransformed[id] = !0, await transform(code, {
        filename: id,
        swcrc: !1,
...
export { index_default as default, swcTransform, transformCommonJs, transformForBuild, transformWithOptions };
